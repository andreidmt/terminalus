...
function Frame(props) {
     ...
     * Parent constructor
     */
    Log.call(this, Object.assign({}, M.clone(DEFAULT_FRAME_PROPS), M.pick(["parent", "label", "top", "left", "width", "height"], props)));
...
Frame.prototype = Object.create(Log.prototype, {
    ...
    respawn: {
        value: function respawn() {
            return M.pipe(M.if(M.isSomething, child => child.kill()), () => spawn(this.props.cmd, this.props.args, {
                cwd: process.cwd(),
                env: process.env,
                detatched: false,
                encoding: "utf8"
...
module.exports = {
    Frame,
    getFrame: props => new Frame(props)
};