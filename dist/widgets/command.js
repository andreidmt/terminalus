 ...
 */
const pipe = (childProcess, logBox, stderr) => {
...
const CMDLogFactory = options => {
    ...
    const logWidget = new Log(Object.assign(M.clone(DEFAULT_BOX_OPTIONS), M.pick(["parent", "label", "top", "left", "width", "height"], options)));
