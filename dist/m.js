 ...
 */
const isSomething = input => input !== null && input !== undefined;
 ...
 * @return {string}
 */
const type = input => input === null ? "Null" : input === undefined ? "Undefined" : Object.prototype.toString.call(input).slice(8, -1);
 ...
 * // { a: "lorem", b: "ipsum" }
 */
const set = (prop, value) => source => Object.defineProperty(source, prop, {
    value,
    writable: true,
    configurable: true,
    enumerable: true
 ...
 * @return     {Object}
 */
const pick = (properties, source) => properties.filter(item => Object.hasOwnProperty.call(source, item)).reduce((acc, item) => set(item, source[item])(acc), {});
 ...
 */
const If = (ifCond, thenFn, elseFn) => source => ifCond(source) === true ? thenFn(source) : typeof elseFn === "function" ? elseFn(source) : source;
